...
pfrb.posterior <- compute.pfrb.posterior(dir_mcmc_tmb, nyr+1)
```
...
::: {#fig-age-comps}
![](../figures/tmb/age_compositions.pdf)
...
![](../figures/tmb/management_outputs.pdf)
