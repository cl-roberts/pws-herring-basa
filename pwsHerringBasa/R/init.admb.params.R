...
#'
#' Provides a set of initial parameter values for BASA's MCMC chains. Initial
#' values are provided in the `PWS_ASA(par).ctl` file and random error is added
#' for intializing each markov chain.
#'
#' @param reps The number of markov chains used in the model.
#'
